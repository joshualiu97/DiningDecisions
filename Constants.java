public class Constants
{
	...
	//location stats  
	public static final int COVEL_LOC[NUM_DINING_HALLS] = new int[NUM_DINING_HALLS]{8,2,3,5,4,6,7,1}; //covel, deneve, bplate, Feast, Rende, 1919, bcaf, Hedrick
	public static final int HEDRICK_LOC[NUM_DINING_HALLS] = new int[NUM_DINING_HALLS]{3,1,2,6,7,5,4,8}; //covel, deneve, bplate, Feast, Rende, 1919, bcaf, Hedrick
	public static final int RIEVER_LOC[NUM_DINING_HALLS] = new int[NUM_DINING_HALLS]{3,1,2,7,8,5,4,6}; //covel, deneve, bplate, Feast, Rende, 1919, bcaf, Hedrick
	public static final int DENEVE_LOC[NUM_DINING_HALLS] = new int[NUM_DINING_HALLS]{4,8,7,2,3,6,5,1}; //covel, deneve, bplate, Feast, Rende, 1919, bcaf, Hedrick
	public static final int SPROUL_LOC[NUM_DINING_HALLS] = new int[NUM_DINING_HALLS]{5,4,8,2,3,6,7,1}; //covel, deneve, bplate, Feast, Rende, 1919, bcaf, Hedrick
	public static final int CAMPUS_LOC[NUM_DINING_HALLS] = new int[NUM_DINING_HALLS]{5,8,7,2,3,4,6,1}; //covel, deneve, bplate, Feast, Rende, 1919, bcaf, Hedrick
